<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\phpStudy\WWW\tp5shop\public/../application/admin\view\goods\create.html";i:1523453468;s:58:"D:\phpStudy\WWW\tp5shop\application\admin\view\layout.html";i:1522653883;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $('#cate_one').change(function(){
                var pid = $(this).val();
                $.ajax({
                    'url':'<?php echo url("category/getCateByPid"); ?>',
                    'type':'post',
                    'data':{'pid':pid},
                    'dataType':'json',
                    'success':function(response){
