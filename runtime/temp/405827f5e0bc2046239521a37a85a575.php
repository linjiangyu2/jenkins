<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\phpStudy\WWW\tp5shop\public/../application/home\view\goods\detail.html";i:1522840138;s:57:"D:\phpStudy\WWW\tp5shop\application\home\view\layout.html";i:1522900920;}*/ ?>
<!DOCTYPE html>
<html>
...
<div id="nav-bottom">
            ...
            <div class="py-container">
                <div class="shortcut">
                    <ul class="fl">
                        ...
                        <li class="f-item">Hi,<a href="<?php echo url('home/member/index'); ?>" target="_blank"><?php echo \think\Session::get('user_info.email'); ?></a>　<span><a href="<?php echo url('home/login/logout'); ?>" target="_blank">退出</a></span></li>
                        <?php elseif((\think\Session::get('user_info.phone'))): ?>
                        <li class="f-item">Hi,<a href="<?php echo url('home/member/index'); ?>" target="_blank"><?php echo encrypt_phone(\think\Session::get('user_info.phone')); ?></a>　<span><a href="<?php echo url('home/login/logout'); ?>" target="_blank">退出</a></span></li>
                        <?php else: ?>
                        <li class="f-item">Hi,<a href="<?php echo url('home/member/index'); ?>" target="_blank"><?php echo \think\Session::get('user_info.username'); ?></a>　<span><a href="<?php echo url('home/login/logout'); ?>" target="_blank">退出</a></span></li>
                        <?php endif; ?>
                    </ul>
                    <ul class="fr">
				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom"><img jqimg="<?php echo $goodspics[0]['pics_big']; ?>" src="<?php echo $goodspics[0]['pics_mid']; ?>" /></span>
						</div>
						<!--下方的缩略图-->
						<div class="spec-scroll">
							...
							<div class="items">
								<ul>
									...
									<li><img src="<?php echo $v['pics_mid']; ?>" bimg="<?php echo $v['pics_big']; ?>" onmousemove="preview(this)" /></li>
									<?php endforeach; ?>
								</ul>
							</div>
							<a class="next">&gt;</a>
				...
				<div class="fr itemInfo-wrap">
					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							<?php foreach($attribute as $v): if(($v['attr_type'] == 1)): ?>
							<dl>
								<dt>
									<div class="fl title">
								...
								<?php foreach($goodsattr[$v['id']] as $k=>$attr): if(($k == 0)): ?>
								<dd><a href="javascript:;" class="selected" goods_attr_id="<?php echo $attr['id']; ?>"><?php echo $attr['attr_value']; ?><span title="点击取消选择">&nbsp;</span></a></dd>
								<?php else: ?>
								<dd><a href="javascript:;"><?php echo $attr['attr_value']; ?><span title="点击取消选择">&nbsp;</span></a></dd>
								<?php endif; endforeach; ?>
							</dl>
							<?php endif; endforeach; ?>
						</div>
						...
						<div class="summary-wrap">
							<div class="fl title">
								<div class="control-group">
									<div class="controls">
										<input autocomplete="off" id="number" type="text" value="1" minnum="1" class="itxt" />
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a href="javascript:;" id="addshopcar" target="_blank" class="sui-btn  btn-danger addshopcar">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
						...
						<div class="tab-content tab-wraped">
							<div id="one" class="tab-pane active">
								<ul class="goods-intro unstyled">
									<?php foreach($attribute as $v): if(($v['attr_type'] == 0)): ?>
									<li><?php echo $v['attr_name']; ?>：<?php echo $goodsattr[$v['id']][0]['attr_value']; ?></li>
									<?php endif; endforeach; ?>
								</ul>
	...
	<form action="<?php echo url('home/cart/addcart'); ?>" method="post">
		<input type="hidden" name="goods_id" value="<?php echo $goods['id']; ?>">
		<input type="hidden" name="goods_attr_ids" value="">
	...
	<script>
		$(function(){
			...
			$('#specification dl dd a').click(function(){
			...
			$('#addshopcar').click(function(){
				...
				//获取到选中的属性值 对应的li标签
				var a_selected = $('.selected');
				//获取属性名称对应的div  用来判断选中的个数
				var dl = $('#specification dl');
				if(a_selected.length != dl.length){
					alert('必须选择商品属性');return;
				}
				var goods_attr_ids = ''; //  12,24,25
				$.each(a_selected, function(i,v){
					//v 就是一个li标签，DOM对象
					goods_attr_ids += $(v).attr('goods_attr_id') + ',';
				});
				//去除最后一个逗号
				goods_attr_ids = goods_attr_ids.slice(0, -1);
				//将拼接好的值 放回到表单对应的隐藏域中
				$('input[name=goods_attr_ids]').val(goods_attr_ids);
				//提交表单
				$('form').submit();
			});
